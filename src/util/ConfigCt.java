...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="1.08";//插件版本号
	public static final String PLUGIN_NAME="pdd.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.pdd";//插件名字；
